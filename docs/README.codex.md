...
```
Fetch and follow instructions from https://raw.githubusercontent.com/alex-kinokon/superpowers-lite/refs/heads/main/.codex/INSTALL.md
```
...
1. Clone the repo:
   ```bash
   git clone https://github.com/alex-kinokon/superpowers-lite.git ~/.codex/superpowers
   ```
